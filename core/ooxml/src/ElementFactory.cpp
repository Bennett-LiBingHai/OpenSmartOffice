...
std::string ElementFactory::makeKey(const std::string& namespaceUri, const std::string& localName) {
    return namespaceUri + "\x1F" + localName;  // 用分隔符避免冲突
}

void ElementFactory::registerCreator(const std::string& namespaceUri, const std::string& localName,
                                     CreatorFn creator) {
